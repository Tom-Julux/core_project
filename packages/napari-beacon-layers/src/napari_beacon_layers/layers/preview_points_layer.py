...
from napari_beacon_layers.controls.preview_points_controls import CustomQtPreviewPointsControls

class PreviewPointsLayer(Points):
    """
...
layer_to_controls[PreviewPointsLayer] = CustomQtPreviewPointsControls
