...
from .trackrad_metrics import (
    DiceMetric, 
    HausdorffDistanceMetric,
    SurfaceDistanceMetric, 
    EuclideanCenterDistanceMetric,
    )

class LabelMetricsWidget(QWidget):
    ...
    def build_gui(self):
        ...
        _ = setup_label(_layout, "Select which set of metrics is computed.")
        _ = setup_combobox(
            _layout, ["A", "B", "C"], "QComboBox", function=lambda: print("QComboBox")
        )
