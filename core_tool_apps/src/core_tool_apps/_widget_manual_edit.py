...
class QuickManualEditWidget(QWidget):
    def __init__(self, viewer: Viewer):
        ...
        self.expected_widgets = {
            "EditLogWidget": EditLogWidget,
            #"PromptableSegmentationWidget2DSAM": PromptableSegmentationWidget2DSAM
        }
