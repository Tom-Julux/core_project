...
class QuickSizeWidget(QWidget):
    ...
    def on_file_selected(self, file_path):
        ...
        widget = PromptableSegmentationWidget2DSAM(self._viewer, hide_model_setup=True, hide_prompt_type_select=False, hide_prompt_import=True, hide_export=False)
...
class QuickSize3DWidget(QWidget):
    ...
    def on_file_selected(self, file_path):
        ...
        widget = PromptableSegmentationWidget3DSAM(self._viewer, hide_model_setup=True, hide_prompt_type_select=False, hide_prompt_import=True, hide_export=False)
        self._viewer.window.add_dock_widget(
            widget, name="Promptable Segmentation", area="right"
        )
        self.sam2d_widget = widget
...
class QuickSize3DNNIWidget(QWidget):
    ...
    def on_file_selected(self, file_path):
        ...
        widget = PromptableSegmentationWidget3DNNI(self._viewer, hide_model_setup=True, hide_prompt_type_select=False, hide_prompt_import=True, hide_export=False)
        self._viewer.window.add_dock_widget(
            widget, name="Promptable Segmentation", area="right"
        )
        self.sam2d_widget = widget
