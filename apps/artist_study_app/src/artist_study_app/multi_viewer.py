...
class MultipleViewerWidget(QSplitter):
    ...
    def __init__(self, viewer: napari.Viewer, orientation = Qt.Orientation.Horizontal) -> None:
        super().__init__()
        self.viewer = viewer
        ...
        viewer_splitter.setOrientation(orientation)
        ...
        self.viewer_model1.dims.current_step = self.viewer.dims.current_step
        self.viewer_model2.dims.current_step = self.viewer.dims.current_step
        self.viewer_model3.dims.current_step = self.viewer.dims.current_step
...
def setup_multiple_viewer_widget(_layout=None, viewer: napari.Viewer=None):
    """
