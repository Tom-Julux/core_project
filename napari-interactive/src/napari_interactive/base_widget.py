...
class InteractiveSegmentationWidgetBase(QWidget):
    ...
    def update_prompt_type(self):
        ...
        if prompt_type == "Points":
            ...
            point_layer_negative = PointPromptLayer(name='Point Point Layer (Negative)', ndim=len(img_layer_shape))
            ...
            bbox_layer = BoxPromptLayer(name='BBox Prompt Layer', ndim=len(img_layer_shape))
